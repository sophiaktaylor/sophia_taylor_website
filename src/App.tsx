        ...
        <div style={{
          ...
          <div style={{ marginBottom: '10px' }}>
            ...
            <div style={{
              ...
              <a href="mailto:sophietaylor1019@gmail.com" rel="noopener noreferrer" aria-label="Email" style={{
                display: 'flex',
                alignItems: 'center',
                textDecoration: 'none'
              }}>
              ...
              <a href="https://www.linkedin.com/in/sophiataylorlinked/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" style={{
                display: 'flex',
                alignItems: 'center',
                textDecoration: 'none'
              }}>
              ...
              <a href="https://github.com/sophiaktaylor" target="_blank" rel="noopener noreferrer" aria-label="GitHub" style={{
                display: 'flex',
                alignItems: 'center',
                textDecoration: 'none'
              }}>
              ...
              <a href="https://reveleer.com" target="_blank" rel="noopener noreferrer" aria-label="Reveleer" style={{
                display: 'flex',
                alignItems: 'center',
                textDecoration: 'none'
              }}>
                <img 
                  src="/images/reveleer-icon.png" 
                  alt="Reveleer" 
                  style={{
                    width: '45x',
                    height: '45px',
